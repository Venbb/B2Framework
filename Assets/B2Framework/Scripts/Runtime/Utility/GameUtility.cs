...
namespace B2Framework
{
    public static partial class GameUtility
    {
        ...
        {
            // 获取主摄像机，将世界坐标转换成屏幕坐标
            var mCamera = (Camera.main != null) ? Camera.main : Camera.current;
            var screenPoint = mCamera.WorldToScreenPoint(worldPiont);
            // var screenPoint = RectTransformUtility.WorldToScreenPoint(mCamera, worldPiont);
